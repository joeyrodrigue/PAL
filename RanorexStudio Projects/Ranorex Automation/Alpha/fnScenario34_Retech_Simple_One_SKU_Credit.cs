...
namespace Alpha
{
    ...
    public class fnDoScenario34 : ITestModule
    {
        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public fnDoScenario34()
        {
        ...
        public void Run()
        {	//*****************Start  Scenario 34 - Retech - Simple One SKU pay with Credit ******************
			...
			Global.LogText = @"---> fnDoScenario34 Iteration: " + Global.CurrentIteration;
			WriteToLogFile.Run();	        	
            Report.Log(ReportLevel.Info, "Scenario 34 IN", "Iteration: " + Global.CurrentIteration, new RecordItemIndex(0));			
            ...
            Global.CurrentMetricDesciption = @"Scenario 34";
			...
			Global.LogText = "<--- fnDoScenario34 Iteration: " + Global.CurrentIteration;
			WriteToLogFile.Run();	      			
            Report.Log(ReportLevel.Info, "Scenario 34 OUT", "Iteration: " + Global.CurrentIteration, new RecordItemIndex(0));
